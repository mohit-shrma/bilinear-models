...
ModelLinSym::ModelLinSym(const Params& params, int nFeatures)
...
float ModelLinSym::estPosRating(int u, int item, const Data& data, 
    Eigen::VectorXf& pdt) {
  float r_ui = 0;
...
float ModelLinSym::estNegRating(int u, int item, const Data& data, 
    Eigen::VectorXf& pdt) {
  float r_ui = 0;
  //TODO: removed this temporary creation
  Eigen::VectorXf pdt1(rank);
